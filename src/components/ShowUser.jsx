...
function ShowUser() {
  ...
  const handleDelete = (user) => {
    ...
    // Delete with params
    fetch(`https://seminar-server.onrender.com/delete/${user._id}`, {
      method: "DELETE",
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-lg p-8">
        <Link to="/" className="flex items-center justify-center w-10 h-10 rounded-full  bg-gray-100 hover:bg-gray-200   text-gray-700 hover:text-black
                  ...
                  <td className="px-6 py-4">
                    <div className="flex justify-center gap-4">
                      ...
                      <Link to={`/user/${user._id}`}>
                        <div className="text-blue-500 hover:text-blue-600 font-medium hover:underline">
                          Edit
                        </div>
                      </Link>
                    </div>
